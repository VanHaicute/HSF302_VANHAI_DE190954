...
public class StudentDAO {
    ...
    public void save(Student student) {
        // TODO #3.1 (5 điểm): Implement method save()
        //   1. Tạo EntityManager mới từ emf
        //   2. begin transaction
        //   3. em.persist(student)
        //   4. commit transaction
        //   5. Nếu exception → rollback + re-throw
        //   6. Cuối cùng (finally) → em.close()
    ...
    public Student findById(Long id) {
        // TODO #3.2 (5 điểm): Implement method findById()
        //   1. Tạo EntityManager
        //   2. Dùng em.find(Student.class, id) để tìm
        //   3. finally → em.close()
    ...
    public List<Student> findAll() {
        // TODO #3.3 (5 điểm): Implement method findAll()
        //   1. Tạo EntityManager
        //   2. Dùng em.createQuery("SELECT s FROM Student s", Student.class).getResultList()
        //   3. finally → em.close()
    ...
    public void update(Student student) {
        // TODO #3.4 (5 điểm): Implement method update()
        //   1. Tạo EntityManager + begin transaction
        //   2. Tìm existingStudent = em.find(Student.class, student.getId())
        //   3. Nếu existingStudent != null:
        //        - Copy các field email/password/firstName/lastName/marks
        //        - (KHÔNG copy id và books)
        //   4. commit
        //   5. Exception → rollback + re-throw
        //   6. finally → em.close()
    ...
    public void delete(Long id) {
        // TODO #3.5 (5 điểm): Implement method delete()
        //   1. Tạo EntityManager + begin transaction
        //   2. Tìm student = em.find(Student.class, id)
        //   3. Nếu student != null → em.remove(student)
        //   4. commit
        //   5. Exception → rollback + re-throw
        //   6. finally → em.close()
