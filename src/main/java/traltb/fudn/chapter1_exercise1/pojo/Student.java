...
public class Student {
    ...
    // TODO: Khai báo các field theo bảng schema trên
    //       Đừng quên @Id + @GeneratedValue cho id
    //       @Column với constraint phù hợp cho từng field

    // TODO: Khai báo Set<Book> books với @OneToMany + @JoinColumn(name = "student_id")
    //       Khởi tạo = new HashSet<>() để tránh NullPointerException
